...
<section class="content-header">
    <div class="container-fluid my-2">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Edit Student Admission form</h1>
            </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" name="student_aadhar_number" id="student_aadhar_number" value="{{$student->student_aadhar_number}}">
                            <p></p>
                        </div>
                        <div class="col-md-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <label>Caste *</label>
                            <input type="text" class="form-control" name="caste" id="caste" value="{{$student->caste}}">
                            <p></p>
                        </div>
                        <div class="col-md-3">
                            <label>Category *</label>
                            <input type="text" class="form-control" name="category" id="category" value="{{$student->category}}">
                            <p></p>
                        </div>
                        <div class="col-md-3">
                            <label>Roll No *</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" name="father_aadhar_number" id="father_aadhar_number" value="{{$student->father_aadhar_number}}">
                            <p></p>
                        </div>
                        <div class="col-md-3">
                            <label>Father Mobile Number 1*</label>
                            <input type="text" class="form-control" name="father_mobile_number_1" id="father_mobile_number_1" value="{{$student->father_mobile_number_1}}">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" name="father_mobile_number_2" id="father_mobile_number_2" value="{{$student->father_mobile_number_2}}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" name="mother_aadhar_number" id="mother_aadhar_number" value="{{$student->mother_aadhar_number}}">
                            <p></p>
                        </div>
                        <div class="col-md-3">
                            <label>Mother Mobile Number 1*</label>
                            <input type="text" class="form-control" name="mother_mobile_number_1" id="mother_mobile_number_1" value="{{$student->mother_mobile_number_1}}">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" name="mother_mobile_number_2" id="mother_mobile_number_2" value="{{$student->father_aadhar_number}}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6" name="discreption">
                            <label>Discreption</label>
                            <textarea name="discription" id="discription" cols="30" rows="10" class="summernote" placeholder="Description" value="{{$student->discription}}"></textarea>
                            <p></p>
                        </div>
                    </div>
                    <div class="row">
